...
def default_site_config(apps, schema_editor):
    ...
    Config.objects.bulk_create(
        [
            Config(key="school_name", value="Makaranta Imam Malick"),
            Config(key="school_slogan", value="Gestion scolaire Imam Malick Makaranta"),
            Config(key="school_address", value="Niamey, Niger"),
        ]
    )
